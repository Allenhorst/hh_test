...
class MessageETHContactID(Base):
    ...
    def __init__(self, message, user_id, device_uid_id, object_number, type_message, contact_code, razdel_number,
...
class AdemcoCode(Base):
    __tablename__ = "Aldemco_Code"
    ...
    def __init__(self, code_id, text_code, type_message):
        self.type_message = type_message
